...
public class CategoryController {
    ...
    @GetMapping
    public Resp<List<CategoryEntity>> queryCategorysByPidOrLevel(@RequestParam(value = "level",defaultValue = "0")Integer level,
                                                                 @RequestParam(value = "prantCid",required = false)Long pid){
